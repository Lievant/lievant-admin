    ...
    startTransition(async () => {
      ...
      try {
        await uploadViaPresignedUrl({
          presignUrl: `/api/vendors/${vendorId}/documents/presigned-upload`,
          registerUrl: `/api/vendors/${vendorId}/documents/register`,
          file,
          extra: { type: documentType, name: name.trim() },
      ...
      <div className="w-full max-w-md rounded-xl bg-white shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 px-6 py-5">
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold uppercase tracking-wide text-slate-500" htmlFor="vendor-doc-type">
              Tipo de documento
            </label>
            <select
              id="vendor-doc-type"
          ...
          <TextField id="vendor-doc-name" label="Nombre" value={name} onChange={setName} />

          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold uppercase tracking-wide text-slate-500" htmlFor="vendor-doc-file">
              Archivo
            </label>
            <input
              id="vendor-doc-file"
